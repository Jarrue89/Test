...
private:
    ...
    double Calculate(std::vector<int>::iterator it_ini, std::vector<int>::iterator it_end);
    double CalculateParts(std::vector<int>::iterator, std::vector<int>::iterator, MultiNumbers multiNumber);
    double CalculateUnits(std::vector<int>::iterator it_ini, std::vector<int>::iterator it_end);
